 ...
 */
public class ControlStructureCalculation extends javax.swing.JFrame {

    /**
     * Creates new form Calculation
     */
    public ControlStructureCalculation() {
        initComponents();
         super.setLocationRelativeTo(null);
        
        String[] com = {"1","2","3","4","5"};
        JComboBox c = new JComboBox(com);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Code Complexcity Tool");
        ...
        jLabel2.setText("Code Complexcity Due to Control Structure");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ControlStructureCalculation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ControlStructureCalculation().setVisible(true);
            }
        });
    }
