 ...
 */
public class InheritanceCalculation extends javax.swing.JFrame {

    /**
     * Creates new form Calculation
     */
    public InheritanceCalculation() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Code Complexcity Due to Inheritance");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InheritanceCalculation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InheritanceCalculation().setVisible(true);
            }
        });
    }
