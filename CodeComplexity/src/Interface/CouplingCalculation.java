 ...
 */
public class CouplingCalculation extends javax.swing.JFrame {

    /**
     * Creates new form Calculation
     */
    public CouplingCalculation() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Code Complexcity Due to Coupling");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CouplingCalculation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CouplingCalculation().setVisible(true);
            }
        });
    }
