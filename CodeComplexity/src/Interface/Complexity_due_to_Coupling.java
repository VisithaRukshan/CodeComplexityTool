 ...
 * @author Shan
 */
public class Complexity_due_to_Coupling extends javax.swing.JFrame {

    /**
     * Creates new form Complexity_due_to_Coupling
     */
    public Complexity_due_to_Coupling() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Complexity_due_to_Coupling.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Complexity_due_to_Coupling().setVisible(true);
            }
        });
    }
