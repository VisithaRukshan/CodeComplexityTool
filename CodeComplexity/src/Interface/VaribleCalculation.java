 ...
 */
public class VaribleCalculation extends javax.swing.JFrame {

    /**
     * Creates new form Calculation
     */
    public VaribleCalculation() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Code Complexcity Due to Variables");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VaribleCalculation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VaribleCalculation().setVisible(true);
            }
        });
    }
