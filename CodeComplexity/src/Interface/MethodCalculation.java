 ...
 */
public class MethodCalculation extends javax.swing.JFrame {

    /**
     * Creates new form Calculation
     */
    public MethodCalculation() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Code Complexcity Due to Method");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MethodCalculation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MethodCalculation().setVisible(true);
            }
        });
    }
